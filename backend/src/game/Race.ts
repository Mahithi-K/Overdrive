...
export class Race {
    ...
    useAbility(userId: string, ability: string, targetId?: string) {
        ...
        if (ability === 'nitro') {
            if (car.nitroUsed) return { success: false, message: 'Nitro Boost already used this race.' };
            car.nitroUsed = true;
        ...
        if (ability === 'risk') {
            if (car.riskUsed) return { success: false, message: 'Risk Shaft already used this race.' };
            car.riskUsed = true;
        ...
        if (ability === 'shield') {
            if (car.shieldUsed) return { success: false, message: 'Safety Shield already used this race.' };
            car.shieldUsed = true;
        ...
        if (ability === 'collide') {
            if (car.collideUsed) return { success: false, message: 'Collide already used this race.' };
